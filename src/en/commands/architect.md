...
level format is `src/en/LEVEL.md`; for starting a new project there are ready-made
skeletons — `src/en/templates/<name>/`. Domain stories and feature code are not
...
2. No skeleton yet — offer a ready-made template: read `src/en/templates/`, pick a
   ...
   folder structure and a draft `AGENTS.md` per the `src/en/LEVEL.md` format.
