...
## Verification
Как проверяется, что история реализована на этом уровне: какими видами тестов
и по каким правилам они формируются (инструменты, расположение файлов, связь
теста с историей, критерий готовности). Описываем правила, а не перечень тестов.
