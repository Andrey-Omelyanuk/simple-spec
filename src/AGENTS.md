...
## Verification
Как проверяется, что план из `plan/` реализован на этом уровне: какими видами
тестов и по каким правилам они формируются (инструменты, расположение файлов,
связь теста с планом через `// plan:`, критерий готовности). Описываем правила,
а не перечень тестов.
