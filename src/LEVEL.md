...
Обязательны три раздела: `Overview`, `Boundaries`, `Verification` — без границы
и способа проверки уровень не уровень. Остальные берёшь по надобности, пустых
не оставляй. Понадобился раздел не из шаблона — значит, факт не нашёл владельца:
